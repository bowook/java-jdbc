...
class Stage0Test {
     ...
     */
//    근데, JdbcDataSource가 결국은 DataSource 인터페이스의 H2 Database 구현체인데, 이렇게 URL, user 그리고 password를 설정해서 하는
//            것이면, DriverManager와 큰 차이가 없는 것 아닌가? 결국 설정 파일로 주입한 것이  아닌데, 애플리케이션 단의 코드라고 생가했을 때
//            동일하게 변경이 생길 것 같은데, 흠...
    //그냥 테스트 코드라서 이렇게 사용한 것인듯.
    @Test
